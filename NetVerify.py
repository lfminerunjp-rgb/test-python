...
def main():
    ...
    while True:
        ...
        while True:
            ...
            except (KeyboardInterrupt, EOFError): os.system('cls' if os.name == 'nt' else 'clear'); show_mode_menu(); break
            ...
            try:
                ...
                for i, idx in enumerate(indices):
                    ...
                    device = { 
                        ...
                        'allow_agent': False, 'look_for_keys': False # 認証エラー回避用
                    }
